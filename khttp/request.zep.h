...
ZEND_BEGIN_ARG_INFO_EX(arginfo_khttp_request_set_proxy, 0, 0, 1)
	ZEND_ARG_ARRAY_INFO(0, proxy, 0)
ZEND_END_ARG_INFO()
...
ZEPHIR_INIT_FUNCS(khttp_request_method_entry) {
	...
	PHP_ME(Khttp_Request, set_proxy, arginfo_khttp_request_set_proxy, ZEND_ACC_PUBLIC)
